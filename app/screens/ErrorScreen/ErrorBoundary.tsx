...
import { ErrorDetails // Reassuring messages for users } from "./ErrorDetails // Reassuring messages for users";

interface Props {
  children: ReactNode // Content of the app;
 ...
 * app. It follows the "error boundary" pattern in React. This friendly chatbot uses a
...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    return this.isEnabled() && this.state.error ? (
      <ErrorDetails // Reassuring messages for users
